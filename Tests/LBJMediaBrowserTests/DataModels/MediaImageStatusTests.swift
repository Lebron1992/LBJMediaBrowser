...
final class MediaImageStatusTests: XCTestCase {
  func test_isLoading() {
    ...
    XCTAssertFalse(MediaImageStatus.loaded(.still(UIImage())).isLoading)
  ...
  func test_isLoaded() {
    ...
    XCTAssertTrue(MediaImageStatus.loaded(.still(UIImage())).isLoaded)
  ...
  func test_isLoadingOrLoaded() {
    ...
    XCTAssertTrue(MediaImageStatus.loaded(.still(UIImage())).isLoadingOrLoaded)
